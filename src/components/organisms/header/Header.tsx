...
const Header: React.FC = () => {
  return (
    ...
    >
      ...
      ></div>
      <nav className="fixed w-full sm:w-[calc(100%-2rem)] lg:max-w-1200 pb-4 pt-10 px-6 sm:p-5 h-25 sm:h-22 lg:px-10 bg-neutral-background sm:bg-primary-default rounded-bl-2xl rounded-br-2xl sm:rounded-full border-b sm:border-none flex justify-between items-center z-50">
        <Logo />
        <MenuItems />
      </nav>
    </div>
