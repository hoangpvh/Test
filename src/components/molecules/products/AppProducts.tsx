...
const AppProducts: React.FC = () => {
  return (
    <div
      className="h-auto w-full xl:w-1200 sm:h-378 gap-10 flex sm:flex-row flex-col justify-center xl:justify-between items-center"
    ...
    >
      ...
      <div
        className="w-342 h-330 sm:w-432 xl:w-532 xl:h-378 relative"
