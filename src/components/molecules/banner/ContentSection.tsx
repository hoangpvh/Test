const ContentSection: React.FC = () => {
  return (
    <div className="w-full h-[209px] lg:h-[206px] lg:px-[200px] flex flex-col justify-start items-center lg:gap-10 gap-5">
      ...
      <div className="h-[74px] lg:px-[60px] 2xl:px-[166px] sm:px-[20%] px-4 py-2.5 grow shrink basis-0 text-center text-[#3d2e7c] leading-[18px] text-sm lg:text-[28px] font-normal font-['Helvetica'] lg:leading-[42.67px]">
